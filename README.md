...
<details>
<summary>Click to see notes and 2D examples </summary>

**Note 1:** Moreover, RIPA does not require a hand-off between AOD and SLM traps which could potentially introduce atom loss.

**Note 2:** For the AOD `log(N)` steps arbitrary re-arrangement algorithm, as demonstrated in the middle panel. See the original paper [constant_overhead_paper](https://www.nature.com/articles/s41567-024-02479-z) and the code [algorithm here](src/scheduler/logL_1d/logL_1d.py).
